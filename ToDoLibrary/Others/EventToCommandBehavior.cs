...
namespace ToDoLibrary.Views
{
	public class EventToCommandBehavior : BehaviorBase<View>
	{
        ...
        public static BindableProperty ItemSelectedCommandProperty = BindableProperty.Create("ItemSelectedCommand",typeof(ICommand),typeof(EventToCommandBehavior), null);
